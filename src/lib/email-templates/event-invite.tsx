...
const footer = { margin: 0, fontSize: '12px', lineHeight: '20px', color: '#8a8578', fontFamily: 'Arial, sans-serif' }
...
const EventInviteEmail = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>
        {isReminder ? `Coming up: ${eventTitle}` : `You're invited: ${eventTitle}`}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={card}>
            ...
            {description ? <Text style={{ ...detail, color: '#33415c' }}>{description}</Text> : null}
          </Section>
